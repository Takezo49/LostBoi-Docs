...
_If the syn scan is taking very long to complete, the following command is an alternative (no service detection)._
...
_Change MYDATABASENAME. Default databasename is mysql._
...
_Very helpful for chars that need to be escaped otherwise._
...
_rlwrap enables the usage of arrow keys in your shell._ [https://github.com/hanslub42/rlwrap](https://github.com/hanslub42/rlwrap)
...
_If `-e` is not allowed, try to find other versions of netcat_
...
_Output in Hex, C Style, Exclude bad chars, Exitfunction thread:_
